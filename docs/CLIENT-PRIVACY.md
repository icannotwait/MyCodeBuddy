...
MyCodeBuddy Client is an iOS client for connecting to a user-provided MyCodeBuddy server.
...
When you connect the app to a MyCodeBuddy server, project data, conversations, messages, files, terminal output, and related activity may be transmitted to and processed by the server you provide. The handling of that data depends on the server and services you configure.
...
Contact: https://github.com/icannotwait/MyCodeBuddy/issues
