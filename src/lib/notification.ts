 ...
 * (`notifyDesktop` / `withDesktopNotificationsSuppressed`). Everything here
 * is the thin, honest wrapper over two very different substrates:
 *
 ...
 *
 * Fork watchdog / turn-complete callers use `sendSystemNotification`, which
 * adds hidden-document gating, conversation click targets, and host dedupe.
 */
