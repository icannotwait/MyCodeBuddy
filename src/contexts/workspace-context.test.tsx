...
describe("reopening a closed file tab", () => {
  ...
  function Probe({ onCapture }: { onCapture: (ids: string[]) => void }) {
    ...
    return (
      <div>
        ...
        <button onClick={() => updateActiveFileContent("dirty")}>
          dirty-active
        </button>
      </div>
    )
  ...
  it("walks a dirty-confirm close-others batch back into its original order", async () => {
    const ids = mount()
    await click("open-a")
    await click("open-b")
    await click("open-c")
    await click("open-d")
    await click("dirty-active")
  ...
  it("rebuilds a dirty-confirm closed-all strip in its original order", async () => {
    const ids = mount()
    await click("open-a")
    await click("open-b")
    await click("open-c")
