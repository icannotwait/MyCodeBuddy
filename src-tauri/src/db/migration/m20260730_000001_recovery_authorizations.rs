...
impl MigrationTrait for Migration {
    async fn up(&self, manager: &SchemaManager) -> Result<(), DbErr> {
        ...
        for statement in [
            ...
            "ALTER TABLE delegation_workflow_manifest_revisions ADD COLUMN recovery_source_state_fingerprint TEXT NULL",
            "ALTER TABLE delegation_workflow_manifest_revisions ADD COLUMN recovery_risk_class TEXT NULL",
