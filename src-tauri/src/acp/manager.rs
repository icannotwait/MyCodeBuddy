...
impl ConnectionManager {
    ...
    async fn send_prompt_linked_impl(
        ...
        // Shared-session tabs bind their conversation key independently of the
        // DB/session ownership transaction above. Reconcile after the shielded
        // phase publishes the authoritative conversation id.
