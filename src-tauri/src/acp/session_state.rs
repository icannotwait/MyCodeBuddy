...
use crate::acp::types::{
    ...
    EventEnvelope, GrokEffortSpec, PermissionOptionInfo, PromptCapabilitiesInfo,
...
pub struct SessionState {
    ...
    pub grok_model_specs: Option<std::collections::HashMap<String, GrokEffortSpec>>,
