...
- `cargo test --lib --features test-utils evidence_scope::tests -- --list`: 16 listed.
...
Focused total: 27 passed, 0 failed.
...
gate identity, and typed Broker error propagation. Final Fixer remediation-context
bytes remain intentionally deferred to Task 14 by the approved Plan.
